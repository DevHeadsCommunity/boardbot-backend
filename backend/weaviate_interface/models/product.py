...
class NewProduct(BaseModel):
    wp_product_id: Optional[int] = None
...
attribute_descriptions = {
    "wp_product_id":     "Original WordPress product ID.",
    "name":              "Name of the product.",
    "slug":              "URL-friendly identifier for the product.",
    "permalink":         "Full URL to access the product.",
    "sku":               "Stock Keeping Unit of the product.",
    "price":             "Current price of the product.",
    "regular_price":     "Regular (non-discounted) price.",
    "sale_price":        "Discounted sale price, if any.",
    ...
    "stock_status":      "Inventory status (e.g., 'instock', 'outofstock').",
    "total_sales":       "Total number of times the item has been sold.",
    "downloadable":      "Whether the product is downloadable (boolean).",
    "virtual":           "Whether the product is virtual (boolean).",
    "download_url":      "URL to download the product file.",
    "image_url":         "URL of the product’s primary image.",
    "date_created":      "Date when the product was first created in WordPress.",
    "date_modified":     "Date when the product was last modified in WordPress.",
    "createdAt":         "Local database record creation timestamp.",
    "updatedAt":         "Local database record update timestamp.",
}
